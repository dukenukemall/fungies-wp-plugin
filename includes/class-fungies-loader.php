...
class Fungies_Loader {
	...
	private function load_dependencies() {
		...
		require_once $dir . 'class-fungies-coupon-mapper.php';
		require_once $dir . 'class-fungies-coupon-sync.php';
		...
		require_once $dir . 'class-fungies-blocks-currency.php';
	}
